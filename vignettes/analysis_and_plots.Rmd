...
# Neccessary Data Structure for {CoreMico}
...
This function takes on the output of `combine_methods`. This plot........ The function has one neccessary argument, but you can include the low and high colors as well as a more informative legend title. 

```{r}
combine_plots(combine_arab)
```
