...
#occupancy_core
core_network_non_common_occupancy_core<-full_human_node_w_num_edges[!names(full_human_node_w_num_edges) %in% intersect(prop_rep_core, human_node_list)]
core_network_commanlity_occupancy_core<-full_human_node_w_num_edges[names(full_human_node_w_num_edges) %in% intersect(prop_rep_core, human_node_list)]
#PropRnR
